...
Renting Out of Flats, the data includes the room rent price and house rent price. we will use the median price to delete the low 25% price make the data more accuracy. we will use box and point to interpret the data, mostly we will use the median price group by the area and room, delete the 25% lower rent price.
